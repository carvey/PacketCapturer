...
namespace MyPacketCapturer
{
    public partial class frmCapture : Form
    {
        ...
        public frmCapture()
        {
            ...
            //Make sure that there is at lest one device
            if(devices.Count < 1)
            {
            ...
            //Get the zero device and display in combobox
            device = devices[0];
        ...
        //Dump the packet data from stringPackets
        ...
        private void sendPacketsToolStripMenuItem_Click(object sender, EventArgs e)
        {
